...
import {getDistrictsRequest} from "../../utills/api";

const OrderFormInputsForBishkek = ({lang}) => {
    ...
    useEffect(async () => {
        try {
         const data = await  getDistrictsRequest(3)
         setDistricts(data)
            console.log(data)
        } catch (e) {
            console.log(e)
                ...
                <div className="order_content_inner">
                    <div className="order_content_inner_item">
                        ...
                        <div>
                            ...
                            <div className="select_tag_parent">
                                <select name="" id="" className="custom_input select_tag" disabled={true}>
                                    <option value="Аламедин">Аламедин</option>
                                    <option value="1-май">1-май</option>
                                    <option value="Свердлов">Свердлов</option>
                    ...
                    <div className="order_content_inner_item">
                        ...
                        <div>
                            ...
                            <div className="select_tag_parent">
                                <select name="" id="" className="custom_input select_tag" disabled={true}>
                                    <option value="Ак-Добо">Ак-Добо</option>
                                </select>
                                <small>*обязательное поле</small>
                                <input
                                    className="custom_input"
...
export default OrderFormInputsForBishkek;
